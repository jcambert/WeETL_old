...
namespace WeETL.Properties
{
    ...
    public static class AbstractionsStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("WeETL.Properties.AbstractionsStrings", typeof(AbstractionsStrings).Assembly);
        ...
        /// <summary>
        ///     An error happenned while '{dbOperation}'
        /// </summary>
        public static string DbError([CanBeNull] object dbOperation)
            => string.Format(
                GetString("DbError", nameof(dbOperation)),
                dbOperation);
